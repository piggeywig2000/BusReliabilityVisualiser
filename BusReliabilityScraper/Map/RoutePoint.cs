...
namespace BusReliabilityScraper.Map
{
    internal class RoutePoint(double easting, double northing, double bearing) : IEquatable<RoutePoint>
    {
        ...
        public static RoutePoint FromWGS84(double longitude, double latitude)
        {
            ...
            //try
            //{
            //    easNor = GeoUK.OSTN.Transform.Etrs89ToOsgb(lonLat);
            //}
            ...
            //    easNor = GeoUK.Convert.ToEastingNorthing(new Airy1830(), new BritishNationalGrid(), cartesian);
            //}
        ...
        public static RoutePoint FromTransXChange(LocationStructure location)
        {
